...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="{{asset('admin/')}}">Admin</a>
...
<!--             <a class="dropdown-item" href="#">Settings</a> -->
    ...
    <div id="wrapper">
      ...
      <li class="nav-item active">
          <a class="nav-link" href="{{asset('admin/deleteuser')}}">
            <i class="fas fa-user-circle fa-fw"></i>
            <span>Delete Users</span>
          </a>
        </li>
      <li class="nav-item active">
          <a class="nav-link" href="{{asset('admin/mgtinven')}}">
            <i class="fas fa-fw fa-table"></i>
            <span>Manage Inventory</span>
          </a>
        </li>
        <li class="nav-item active">
          <a class="nav-link" href="{{asset('admin/vieworder')}}">
            <i class="fas fa-fw fa-table"></i>
            <span>Manage Orders</span></a>
        </li>
        <li class="nav-item active">
          <a class="nav-link" href="{{asset('admin/expdate')}}">
            <i class="fas fa-fw fa-table"></i>
            <span>Check Expiary Dates</span></a>
        </li>
      </ul>
      ...
      <div id="content-wrapper">
        ...
        <!-- Sticky Footer -->
        <footer class="footer" style="position: fixed; margin-top: 100%;">
